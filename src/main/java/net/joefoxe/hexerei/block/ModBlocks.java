...
//            () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2).setRequiresTool().explosionResistance(5f)));
    ...
    public static final RegistryObject<MixingCauldron> MIXING_CAULDRON = registerBlock("mixing_cauldron",
            () -> new MixingCauldron(AbstractBlock.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(3, 4F).lightLevel(state -> 12)));

    public static final RegistryObject<CandleDipper> CANDLE_DIPPER = registerBlock("candle_dipper",
            () -> new CandleDipper(AbstractBlock.Properties.of(Material.METAL).noCollission().noOcclusion().strength(3, 8f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Coffer> COFFER = registerBlock("coffer",
            () -> new Coffer(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).strength(2, 8f)));
    ...
    public static final RegistryObject<Altar> BOOK_OF_SHADOWS_ALTAR = registerBlock("book_of_shadows_altar",
            () -> new Altar(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).strength(2, 2f)));

//    public static final RegistryObject<Block> SAGE_BUNDLE_PLATE = registerBlock("sage_bundle_plate",
//            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2, 2f)));

    public static final RegistryObject<SageBlock> SAGE = BLOCKS.register("sage_crop",
            () -> new SageBlock(AbstractBlock.Properties.copy(Blocks.WHEAT)));

    public static final RegistryObject<PestleAndMortar> PESTLE_AND_MORTAR = registerBlock("pestle_and_mortar",
            () -> new PestleAndMortar(AbstractBlock.Properties.of(Material.STONE).strength(2, 2f)));

    public static final RegistryObject<SageBurningPlate> SAGE_BURNING_PLATE = registerBlock("sage_burning_plate",
            () -> new SageBurningPlate(AbstractBlock.Properties.of(Material.METAL).strength(1, 2f)));

    public static final RegistryObject<CrystalBall> CRYSTAL_BALL = registerBlock("crystal_ball",
            () -> new CrystalBall(AbstractBlock.Properties.of(Material.METAL).strength(2, 2f).lightLevel(state -> 9)));

    public static final RegistryObject<HerbJar> HERB_JAR = registerBlockNoItem("herb_jar",
            () -> new HerbJar(AbstractBlock.Properties.of(Material.GLASS).strength(1, 0.5f)));

    public static final RegistryObject<HerbDryingRackFull> HERB_DRYING_RACK_FULL = registerBlock("herb_drying_rack_full",
            () -> new HerbDryingRackFull(AbstractBlock.Properties.of(Material.WOOD).strength(1, 2f)));

    public static final RegistryObject<HerbDryingRack> HERB_DRYING_RACK = registerBlock("herb_drying_rack",
            () -> new HerbDryingRack(AbstractBlock.Properties.of(Material.WOOD).strength(1, 2f)));

    public static final RegistryObject<Candelabra> CANDELABRA = registerBlock("candelabra",
            () -> new Candelabra(AbstractBlock.Properties.of(Material.METAL).strength(1, 2f).lightLevel(state -> state.getValue(Candelabra.LIT) ? 15 : 0)));

    public static final RegistryObject<Candle> CANDLE = registerBlock("candle",
            () -> new Candle(AbstractBlock.Properties.of(Material.VEGETABLE).noCollission().noOcclusion().strength(1, 0.5f).lightLevel(state -> Math.min(state.getValue(Candle.CANDLES_LIT) * 12, 15))));
    ...
    public static final RegistryObject<MahoganyLog> MAHOGANY_LOG = registerBlock("mahogany_log",
            () -> new MahoganyLog(AbstractBlock.Properties.copy(Blocks.OAK_LOG)));

    public static final RegistryObject<MahoganyWood> MAHOGANY_WOOD = registerBlock("mahogany_wood",
            () -> new MahoganyWood(AbstractBlock.Properties.copy(Blocks.OAK_WOOD)));
    ...
    public static final RegistryObject<StairsBlock> MAHOGANY_STAIRS = registerBlock("mahogany_stairs",
            () -> new StairsBlock(() -> MAHOGANY_PLANKS.get().defaultBlockState(),
                    AbstractBlock.Properties.copy(Blocks.OAK_PLANKS)));

    public static final RegistryObject<FenceBlock> MAHOGANY_FENCE = registerBlock("mahogany_fence",
            () -> new FenceBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS)));

    public static final RegistryObject<FenceGateBlock> MAHOGANY_FENCE_GATE = registerBlock("mahogany_fence_gate",
            () -> new FenceGateBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS)));

    public static final RegistryObject<SlabBlock> MAHOGANY_SLAB = registerBlock("mahogany_slab",
            () -> new SlabBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS)));

    public static final RegistryObject<WoodButtonBlock> MAHOGANY_BUTTON = registerBlock("mahogany_button",
            () -> new WoodButtonBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).noCollission()));

    public static final RegistryObject<PressurePlateBlock> MAHOGANY_PRESSURE_PLATE = registerBlock("mahogany_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING ,AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).noCollission()));

    public static final RegistryObject<DoorBlock> MAHOGANY_DOOR = registerBlock("mahogany_door",
            () -> new DoorBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).noOcclusion()));

    public static final RegistryObject<TrapDoorBlock> MAHOGANY_TRAPDOOR = registerBlock("mahogany_trapdoor",
            () -> new TrapDoorBlock(AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).noOcclusion()));

    public static final RegistryObject<LeavesBlock> MAHOGANY_LEAVES = registerBlock("mahogany_leaves",
            () -> new LeavesBlock(AbstractBlock.Properties.copy(Blocks.OAK_LEAVES).randomTicks().sound(SoundType.AZALEA_LEAVES).noOcclusion().isSuffocating(Properties::never).isViewBlocking(Properties::never)));
    ...
    public static final RegistryObject<WillowLog> WILLOW_LOG = registerBlock("willow_log",
            () -> new WillowLog(AbstractBlock.Properties.copy(Blocks.OAK_LOG)));

    public static final RegistryObject<WillowWood> WILLOW_WOOD = registerBlock("willow_wood",
            () -> new WillowWood(AbstractBlock.Properties.copy(Blocks.OAK_WOOD)));
    ...
    public static final RegistryObject<StairsBlock> WILLOW_STAIRS = registerBlock("willow_stairs",
            () -> new StairsBlock(() -> WILLOW_PLANKS.get().defaultBlockState(),
                    AbstractBlock.Properties.copy(Blocks.OAK_PLANKS)));

    public static final RegistryObject<Block> WILLOW_VINES = registerBlock("willow_vines",
            () -> new WillowVinesBlock(AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.WEEPING_VINES)));

    public static final RegistryObject<Block> WILLOW_VINES_PLANT = registerBlockNoItem("willow_vines_plant",
            () -> new WillowVinesPlantBlock(AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.WEEPING_VINES)));
    ...
    public static final RegistryObject<LeavesBlock> WILLOW_LEAVES = registerBlock("willow_leaves",
            () -> new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().sound(SoundType.AZALEA_LEAVES).noOcclusion().isSuffocating(Properties::never).isViewBlocking(Properties::never)));

    public static final RegistryObject<SaplingBlock> WILLOW_SAPLING = registerBlock("willow_sapling",
            () -> new SaplingBlock(new WillowTree(), AbstractBlock.Properties.copy(Blocks.OAK_SAPLING)));

    public static final RegistryObject<FloweringLilyPadBlock> LILY_PAD_BLOCK = registerBlockNoItem("flowering_lily_pad",
            () -> new FloweringLilyPadBlock(AbstractBlock.Properties.of(Material.VEGETABLE).instabreak().sound(SoundType.LILY_PAD).noOcclusion()));

    public static final RegistryObject<PickableFlower> MANDRAKE_FLOWER = registerBlock("mandrake_flower",
            () -> new PickableFlower(Effects.REGENERATION, 3, AbstractBlock.Properties.copy(Blocks.DANDELION), ModItems.MANDRAKE_FLOWERS, 2, ModItems.MANDRAKE_ROOT, 1){


                @Override
                public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> tooltip, ITooltipFlag flagIn) {

                    tooltip.add(new TranslationTextComponent("tooltip.hexerei.found_in_swamp").withStyle(Style.EMPTY.withColor(Color.fromRgb(0x999999))));
                    super.appendHoverText(stack, world, tooltip, flagIn);
                }
            });

    public static final RegistryObject<PickableFlower> BELLADONNA_FLOWER = registerBlock("belladonna_flower",
            () -> new PickableFlower(Effects.POISON, 3, AbstractBlock.Properties.copy(Blocks.DANDELION), ModItems.BELLADONNA_FLOWERS, 2, ModItems.BELLADONNA_BERRIES, 6){
...
//            () -> new PickableFlower(MobEffects.POISON, 3, BlockBehaviour.Properties.copy(Blocks.DANDELION), new ItemStack(ModItems.BELLADONNA_FLOWERS.get(), 4),  new ItemStack(ModItems.BELLADONNA_BERRIES.get(), 5), 5));
    ...
    public static final RegistryObject<PickableDoubleFlower> MUGWORT_BUSH = registerBlock("mugwort_bush",
            () -> new PickableDoubleFlower(Effects.GLOWING, 10, AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.AZALEA), ModItems.MUGWORT_LEAVES, 4, ModItems.MUGWORT_FLOWERS, 3){
    ...
    public static final RegistryObject<PickableDoubleFlower> YELLOW_DOCK_BUSH = registerBlock("yellow_dock_bush",
            () -> new PickableDoubleFlower(Effects.GLOWING, 10, AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.AZALEA), ModItems.YELLOW_DOCK_LEAVES, 4, ModItems.YELLOW_DOCK_FLOWERS, 3){
...
//    public static final RegistryObject<AmethystBlock> SELENITE_BLOCK = registerBlock("selenite_block", TODO: There's no Amethyst blocks in 1.16.5
//            () -> new AmethystBlock(AbstractBlock.Properties.of(Material.AMETHYST, MaterialColor.TERRACOTTA_WHITE).strength(0.5F).sound(SoundType.AMETHYST).noOcclusion()));
//
//    public static final RegistryObject<AmethystBlock> BUDDING_SELENITE = registerBlock("budding_selenite",
//            () -> new BuddingSelenite(AbstractBlock.Properties.of(Material.AMETHYST).randomTicks().strength(1.0F).sound(SoundType.AMETHYST).noOcclusion()));
//
//    public static final RegistryObject<AmethystBlock> SELENITE_CLUSTER = registerBlock("selenite_cluster",
//            () -> new AmethystClusterBlock(7, 3, AbstractBlock.Properties.of(Material.AMETHYST).noOcclusion().strength(0.5F).randomTicks().sound(SoundType.AMETHYST_CLUSTER).noOcclusion().lightLevel((p_152632_) -> {
//                return 5;
//            })));
//
//    public static final RegistryObject<AmethystBlock> LARGE_SELENITE_BUD = registerBlock("large_selenite_bud",
//            () -> new AmethystClusterBlock(5, 3, AbstractBlock.Properties.copy(Blocks.AMETHYST_CLUSTER).sound(SoundType.MEDIUM_AMETHYST_BUD).noOcclusion().lightLevel((p_152629_) -> {
//                return 4;
//            })));
//
//    public static final RegistryObject<AmethystBlock> MEDIUM_SELENITE_BUD = registerBlock("medium_selenite_bud",
//            () -> new AmethystClusterBlock(4, 3, AbstractBlock.Properties.copy(Blocks.AMETHYST_CLUSTER).sound(SoundType.LARGE_AMETHYST_BUD).noOcclusion().lightLevel((p_152617_) -> {
//                return 2;
//            })));
//
//    public static final RegistryObject<AmethystBlock> SMALL_SELENITE_BUD = registerBlock("small_selenite_bud",
//            () -> new AmethystClusterBlock(3, 4, AbstractBlock.Properties.copy(Blocks.AMETHYST_CLUSTER).sound(SoundType.SMALL_AMETHYST_BUD).noOcclusion().lightLevel((p_187409_) -> {
//                return 1;
//            })));

    // SIGILS
    public static final RegistryObject<Block> BLOOD_SIGIL = registerBlockNoItem("blood_sigil",
            () -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(2, 5f).requiresCorrectToolForDrops()));

    // BLOCK PARTIALS

    public static final RegistryObject<Block> CANDLE_DIPPER_WICK_BASE = registerBlockNoItem("candle_dipper_wick_base",
            () -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(0, 1f).noCollission()));

    public static final RegistryObject<Block> CANDLE_DIPPER_WICK = registerBlockNoItem("candle_dipper_wick",
            () -> new Block(AbstractBlock.Properties.of(Material.VEGETABLE).strength(0, 1f).noCollission()));
    ...
    public static final RegistryObject<Block> CANDLE_0_OF_7 = registerBlockNoItem("candle_0_of_7",
            () -> new Candle(AbstractBlock.Properties.of(Material.VEGETABLE).strength(0, 1f).noCollission()));
    ...
    public static final RegistryObject<Block> CRYSTAL_BALL_ORB = registerBlockNoItem("crystal_ball_orb",
            () -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(0, 2f)));
    ...
    public static final RegistryObject<Block> COFFER_LID = registerBlockNoItem("coffer_lid",
            () -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(3).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> COFFER_CONTAINER = registerBlockNoItem("coffer_container",
            () -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(2,8f)));
            ...
            itemBlock = new BlockItem(block, itemProperties) {
                ...
                public void initializeClient(@Nonnull Consumer<IItemRenderProperties> consumer) {
                    consumer.accept(new IItemRenderProperties() {
                        final ItemStackTileEntityRenderer myRenderer = new ItemStackTileEntityRenderer(Minecraft.getInstance().getBlockEntityRenderDispatcher(), Minecraft.getInstance().getEntityModels()) {
