...
@OnlyIn(Dist.CLIENT)
public class DowsingRod2Particle extends SpriteTexturedParticle {
    ...
    public DowsingRod2Particle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
        super(world, x, y, z);
        this.xd = motionX;
        this.yd = motionY;
        this.zd = motionZ;
