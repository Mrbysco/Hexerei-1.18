...
public class DipperContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public DipperContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
...
//        });
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, ModBlocks.CANDLE_DIPPER.get());
    }
