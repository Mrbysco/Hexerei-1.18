...
public class BroomNetheriteTipModel extends SegmentedModel<BroomEntity> {
    ...
    private final ModelRenderer NetheriteTip;

    public BroomNetheriteTipModel(ModelRenderer root) {
