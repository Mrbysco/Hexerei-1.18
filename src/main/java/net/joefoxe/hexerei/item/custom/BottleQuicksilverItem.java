...
public class BottleQuicksilverItem extends Item {
    ...
    public static Food FOOD = new Food.Builder().saturationMod(1).nutrition(1).alwaysEat().effect(new EffectInstance(Effects.HUNGER, 600, 0), 0.8F).effect(new EffectInstance(Effects.POISON, 300, 0), 0.8F).build();
    ...
    public void appendHoverText(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(Screen.hasShiftDown()) {
            ...
            tooltip.add(new TranslationTextComponent("tooltip.hexerei.bottle_quicksilver_shift").withStyle(Style.EMPTY.withColor(Color.fromRgb(0x999999))));
        } else {
